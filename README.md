...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/qjson-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/qjson-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/qjson-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/qjson-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/qjson-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/qjson-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/qjson/badges/version.svg)](https://anaconda.org/conda-forge/qjson)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/qjson/badges/downloads.svg)](https://anaconda.org/conda-forge/qjson)
